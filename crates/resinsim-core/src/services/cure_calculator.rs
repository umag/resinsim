...
impl CureCalculator {
    ...
    pub fn cure_depth(dp: PenetrationDepth, energy: Energy, critical_energy: Energy) -> CureDepth {
        CureDepth(dp.value() * (energy.value() / critical_energy.value()).ln())
    }
...
mod tests {
    ...
    fn intensity_at_surface_equals_i0() {
        let i = CureCalculator::intensity_at_depth(5.0, 0.0, PenetrationDepth(170.0));
    ...
    fn intensity_at_dp_equals_i0_over_e() {
        ...
        let i = CureCalculator::intensity_at_depth(5.0, 170.0, PenetrationDepth(170.0));
        assert!((i - 1.839).abs() < 0.001);
    }

    #[test]
    fn intensity_at_2dp_equals_i0_over_e2() {
        let i = CureCalculator::intensity_at_depth(5.0, 340.0, PenetrationDepth(170.0));
    ...
    fn intensity_at_50um() {
        ...
        let i = CureCalculator::intensity_at_depth(5.0, 50.0, PenetrationDepth(170.0));
