...
impl ReportGenerator {
    ...
    pub fn text_format(sim: &PrintSimulation, ctx: &ReportContext) -> String {
        ...
        out.push_str(&format!("  Max temperature: {:.1}°C\n", summary.max_temperature_c));
        out.push_str(&format!(
...
mod tests {
    ...
    fn text_format_pass_no_failures() {
        ...
        let expected = "Print health report: /fixtures/test.stl\n  \
Resin: Test Resin, Printer: Test Printer\n  \
Supports: 4 x 0.5mm radius\n\
\n\
Summary (2 layers):\n  \
Max peel force: 12.0 N at layer 1\n  \
Min safety factor: 4.50 at layer 1\n  \
Max temperature: 26.0°C\n  \
Max Z deflection: 30.0 µm\n\
\n\
